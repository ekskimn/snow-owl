 ...
 *
 */
public abstract class AbstractSnomedRf1CoreExporter<T extends SnomedDocument> extends AbstractSnomedCoreExporter<T> {
	...
	public String getFileName() {
		return SnomedRfFileNameBuilder.buildCoreRf1FileName(getType(), getExportContext());
	}
