...
public class SnomedMergeApiTest extends AbstractSnomedApiTest {
	...
	private void assertRelationshipCanBeDeleted(final IBranchPath branchPath, final String symbolicName) {
		assertComponentCanBeDeleted(branchPath, symbolicName, SnomedComponentType.RELATIONSHIP);
	}
