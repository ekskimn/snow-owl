...
`snowowl listrepositories` enumerates all the repositories available in Snow Owl.
...
`snowowl listbranches [repository]` enumerates the branches that belong to a particular repository.

---------------------------
osgi> snowowl listbranches snomedStore
Repository snomedStore branches:
MAIN
 2012-01-31
 2012-07-31
 2013-01-31
