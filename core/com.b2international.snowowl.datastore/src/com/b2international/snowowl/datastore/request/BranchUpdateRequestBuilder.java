...
import com.b2international.snowowl.datastore.events.UpdateBranchRequest;

/**
 * @since 4.5
 */
public final class BranchUpdateRequestBuilder {
	...
	BranchUpdateRequestBuilder(String repositoryId, String path) {
	...
	public Request<ServiceProvider, Branch> build() {
		return RepositoryRequests.wrap(repositoryId, new UpdateBranchRequest(path, metadata));
	}
