 ...
 * @since 4.2
 */
public class ReadMergeReviewDetailsEvent extends MergeReviewEvent {

	public ReadMergeReviewDetailsEvent(final String repositoryId, final String mergeReviewId) {
