...
public class CDOBranchImpl extends BranchImpl implements InternalCDOBasedBranch {
	...
	public InternalCDOBasedBranch withSegmentId(int segmentId) {
		...
		CDOBranchImpl branch = new CDOBranchImpl(name(), parentPath(), baseTimestamp(), headTimestamp(), isDeleted(), metadata(), cdoBranchId(), segmentId, builder.build(), parentSegments);
